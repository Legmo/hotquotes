...
Отображаетс случайную цитату из заранее подготовленного файла-хранилища. Каждая цитата может сопровождаться следующими данными: автор, источник, один или несколько тэгов.<br>
В качестве хранилища цитат исполььзуется JSON-файл. В будущем планируется использование базы данных.<br>
<br>
Также планируюется: досту пользователям на добавление собственных цитат (публичных или только для личного просмотра), создание персональных подборок цитат, возможность делиться цитатами и многое другое.
<br>
<br>
...
Скачате проект и выполните следующие консольные команды в папке локального проекта:
- `npm i` — скачать и установить моудли Node.js.
